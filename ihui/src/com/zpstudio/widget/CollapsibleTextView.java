...
public class CollapsibleTextView extends LinearLayout implements
    ...
    public CollapsibleTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        shrinkup = context.getString(R.string.collapsibletextview_desc_shrinkup);
        spread = context.getString(R.string.collapsibletextview_desc_spread);
        View view = inflate(context, R.layout.collapsibletextview, this);
