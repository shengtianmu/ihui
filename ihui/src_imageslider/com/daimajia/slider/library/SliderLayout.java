...
import com.daimajia.slider.library.Tricks.PagerAdapterEx;
...
public class SliderLayout extends RelativeLayout{
    ...
    public SliderLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        PagerAdapterEx wrappedAdapter = new InfinitePagerAdapter(mSliderAdapter);
    ...
    private InfinitePagerAdapter getWrapperAdapter(){
        PagerAdapterEx adapter = mViewPager.getAdapter();
        if(adapter!=null){
